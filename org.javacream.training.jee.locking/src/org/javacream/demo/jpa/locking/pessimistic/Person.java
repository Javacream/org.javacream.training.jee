package org.javacream.demo.jpa.locking.pessimistic;
...
@Entity(name="PessimisticPerson")
@Table(name = "PEOPLE_PESSIMISTIC")
...
public class Person {
	...
	public String toString() {
		return "Person [socialId=" + socialId + ", lastname=" + lastname
				...
				+ ", height=" + height + ", gender=" + gender + ", personId="
				+ personId + ", toString()=" + super.toString() + "]";
	}
